...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<link rel="stylesheet" href="/searchku/Public/css/login.css" />
		<meta http-equiv="Content-Type" content="text/html;charset=utf-8">
		<script type="text/javascript" src="/searchku/Public/js/jquery-1.11.1.min.js"></script>
		<script type="text/javascript" src="/searchku/Public/js/login.js"></script>
		<script type="text/javascript" >
		 var verURL = <?php echo U("Admin/Login/verity" , '' , '');?>;
		...
		<div class="login">	
			...
			<table border="1" width="100%">
				...
				<tr>
					<th>验证码:</th>
					<td>
						<input type="code" class="len250" name="code"/> <img src="<?php echo U('Admin/Login/verity', '', '');?>" id="code"/> <a href="javascript:void(change_code(this));">看不清</a>
					</td>
				</tr>
				<tr>
